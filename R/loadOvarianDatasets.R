#' Function to load ovarian cancer SummarizedExperiment objects from the Experiment Hub
#'
                            ...
                            keepCommonOnly = FALSE, imputeMissing = FALSE, removeDuplicates = FALSE)
{
  ...
  {
    dataList[[i]] = ovarianData[[names(ovarianData)[i]]]
    names(dataList)[i] = ovarianData[i]$title
  }
